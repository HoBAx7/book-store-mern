  ...
  return (
    <div className='h-[calc(100vh-120px)] flex justify-center items-center'>
        <div className='w-full max-w-sm mx-auto bg-white shadow-sm rounded-tl-2xl rounded-br-2xl  '>
            ...
            <div className='flex justify-center py-3 bg-primary rounded-tl-2xl relative overflow-clip'>
                ...
                <span className='text-xs text-white absolute left-10 top-5  animate-slide-fast whitespace-nowrap'>Subs & Gifts</span>
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <div className='relative px-6 py-4 h-18 mt-4'>
                    ...
                    {
                        message && <p className='text-red-300 text-xs italic p-1'>{ message }</p> 
                    }
                </div>
                ...
                <div className='w-full px-6 py-6 flex sm:flex-row flex-col  justify-between text-sm text-gray-500'>
                    <div className='mt-2'>
                        Have Account ? <Link to="/login" className='hover:underline text-amber-600'>Login</Link>
                    </div>
                    <button className='bg-primary sm:w-1/2 w-full py-2 rounded-sm hover:bg-yellow-500 font-bold text-white'>Sign Up</button>
                </div>
